...
if submit_button:
    ...
    class PDF(FPDF):
        ...
        def add_cash_flow_table(self, df_cash_flows_pdf, currency_symbol):
            ...
            col_widths = [20, 40, 40, 40, 40]  # Adjust column widths as needed
        ...
        def add_energy_table(self, df_cash_flows):
            ...
            col_widths = [20, 60, 60]  # Adjust column widths as needed
    ...
    def provide_pdf_download_link(pdf_content, file_name):
        ...
        b64 = base64.b64encode(pdf_content).decode()  # Decoding to UTF-8 string
